...
const useDataProxyRecents = ()=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{
        if (useFallback && fallbackQueryResult.data) {
            ...
            setFetchStatus('loading');
            // Ensure data is an array even when loading
...
_s(useDataProxyRecents, "CUb5NvkJVhGchrf2REn1uThookU=", false, function() {
    return [
...
(() => {
__webpack_require__.h = () => ("1a5e047e8d9a2b22")
})();

}
);
//# sourceMappingURL=main.835452353d829939.hot-update.js.map