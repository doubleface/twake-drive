...
const useDataProxyRecents = ()=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{
        const fetchRecents = async ()=>{
            ...
            if (client) {
                try {
                    const result = await client.fetchQueryAndGetFromState(recentQuery.definition(), recentQuery.options);
...
(() => {
__webpack_require__.h = () => ("d74a33dedfd07df4")
})();

}
);
//# sourceMappingURL=main.8adf169f2e2eea29.hot-update.js.map