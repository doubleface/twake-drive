...
const useDataProxyRecents = ()=>{
    ...
    // const fallbackDataLength = useMemo(
    //   () => fallbackQueryResult.data?.length ?? 0,
    //   [fallbackQueryResult.data]
    // )
    const fallbackDataLength = ((_fallbackQueryResult_data = fallbackQueryResult.data) === null || _fallbackQueryResult_data === void 0 ? void 0 : _fallbackQueryResult_data.length) ?? 0;
...
(() => {
__webpack_require__.h = () => ("3ef1f9c8753ae58a")
})();

}
);
//# sourceMappingURL=main.5a053eecc50e0824.hot-update.js.map