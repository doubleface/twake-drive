...
const useDataProxyRecents = ()=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{
        ...
        if (fallbackData && fallbackData !== prevFallbackDataRef.current) {
            ...
            setFetchStatus('loaded');
            setError(null);
        } else if (fallbackStatus === 'error' && fallbackStatus !== prevFallbackStatusRef.current) {
            prevFallbackStatusRef.current = fallbackStatus;
            setFetchStatus('error');
            setError(fallbackError);
        } else if (fallbackStatus === 'loading' && fallbackStatus !== prevFallbackStatusRef.current && fetchStatus !== 'loading') {
            prevFallbackStatusRef.current = fallbackStatus;
            setFetchStatus('loading');
        }
    }, [
...
(() => {
__webpack_require__.h = () => ("4c2215d5e4f125c1")
})();

}
);
//# sourceMappingURL=main.8ed1192158d84418.hot-update.js.map