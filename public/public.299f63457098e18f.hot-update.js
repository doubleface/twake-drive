...
const computePath = (file, param)=>{
    ...
    switch(type){
        ...
        case 'shared-drive-file':
            if (!driveId || (0,_modules_nextcloud_helpers__WEBPACK_IMPORTED_MODULE_2__.isNextcloudFile)(file) || !file.dir_id) {
...
(() => {
__webpack_require__.h = () => ("eec8d1ff3e1d6cf9")
})();

}
);
//# sourceMappingURL=public.299f63457098e18f.hot-update.js.map